...
object ViewGenerator {
    val items = listOf(
            ...
            SecondaryCard(title = "Landscape #2.2", description = "Section #2 & Image #2", image = R.drawable.image4),
            TitleItem(title = "Section #3"),
            SecondaryCard(title = "Landscape #3.1", description = "Section #2 & Image #1", image = R.drawable.image1),
            SecondaryCard(title = "Landscape #3.2", description = "Section #2 & Image #2", image = R.drawable.image3),
            SecondaryCard(title = "Landscape #3.3", description = "Section #2 & Image #3", image = R.drawable.image4)
